"""
Local Whisper Transcribe Example

This module demonstrates how to use Local Whisper for transcript generation.
"""
...
logging.basicConfig(
    filename="./logs/example-whisper.log",
    level=logging.INFO,
...
def transcribe(
    transcriber: LocalWhisperTranscriber, prompt: str, filepath: str, tmp_directory: str
) -> str | None:
    """
...
if __name__ == "__main__":
    ...
    ASSETS_DIRECTORY = "./assets"  # Downloaded model file will be stored here
    ...
    whisper_1 = LocalWhisperTranscriber(
    ...
    whisper_2 = LocalWhisperTranscriber(
        config=TranscriptionConfig(
            name=MODEL_NAME,
            return_n=1,
            max_iteration=1,
