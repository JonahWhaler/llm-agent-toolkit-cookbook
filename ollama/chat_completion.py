"""
Ollama Chat Completion Example

This module demonstrates how to use the Ollama text-to-text API for generating chat
completions in both single-round and multi-round (interactive) modes.
"""

import logging
from llm_agent_toolkit import ChatCompletionConfig
from llm_agent_toolkit.core.local import OllamaCore, Text_to_Text
...
def generate(llm: Text_to_Text, prompt: str) -> str | None:
    ...
    Returns:
        ...
        TokenUsage | None: The recorded token usage information, or None if an error occurs.
