"""
Gemini Chat Completion Example

This module demonstrates how to use the Gemini  text-to-text API for generating chat
...
from llm_agent_toolkit.core.gemini import GeminiCore, Text_to_Text
