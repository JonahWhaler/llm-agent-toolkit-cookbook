"""
Gemini Chat Completion Example with JSON Output

This module demonstrates how to use the Gemini text-to-text API for generating chat completions that output results in JSON format.
...
def generate(llm: GMN_StructuredOutput_Core, prompt: str) -> str | None:
    ...
    Args:
        llm (GMN_StructuredOutput_Core): An instance configured for text-to-text interactions with JSON output.
